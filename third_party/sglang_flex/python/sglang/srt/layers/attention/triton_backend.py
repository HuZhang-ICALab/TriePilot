    ...
    def _forward_extend_unified(
        ...
        if layer.sliding_window_size is not None and layer.sliding_window_size > -1:
            ...
            if forward_batch.extend_prefix_lens is not None:
                ...
                if forward_batch.spec_info is not None and hasattr(
                    ...
                    if getattr(forward_batch.spec_info, "draft_lens", None) is not None:
                        extend_prefix_lens = (
                            forward_batch.seq_lens[:bs]
                            - forward_batch.spec_info.draft_lens.to(
        ...
        if forward_batch.extend_seq_lens is None:
            ...
            if forward_batch.spec_info is not None and hasattr(
                ...
                if getattr(forward_batch.spec_info, "draft_lens", None) is not None:
                    extend_seq_lens = forward_batch.spec_info.draft_lens.to(
